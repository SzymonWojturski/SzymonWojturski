...
**A passionate problem solver, tackling computationally intensive challenges and complex algorithms.**  
Enjoys approaching games using algorithms to refine strategies.
